...
TODO: VScript conversion, fix ÜberCharge invulnerability and knock back/movement immunity respawn (add speed boost and change duration to 3 seconds), and add Mark for Death Immunity duration after capturing the point (overheal for last player?).
