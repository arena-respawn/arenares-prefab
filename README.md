...
TODO: Fix respawn ÜberCharge invulnerability and knock back/movement immunity (adjusted to 3 seconds) and add Mark for Death Immunity after capturing the point.
