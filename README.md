...
TODO: VScript conversion, fix ÜberCharge invulnerability and knock back/movement immunity respawn (custom duration for each classes) and add Mark for Death Immunity duration after capturing the point.
