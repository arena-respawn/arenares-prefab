...
TODO: VScript conversion, fix ÜberCharge invulnerability and knock back/movement immunity respawn (add speed boost) and add Mark for Death Immunity duration after capturing the point.
