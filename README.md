...
- When a player captures the point, their teammates respawn (uber invulnerability and explosive immunity for 5 seconds), and timer is set to 1 minute and 20 seconds.
