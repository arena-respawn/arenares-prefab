...
TODO: Fix respawn ÜberCharge invulnerability and knock back/movement immunity duration (for x based seconds based on class, scout 3 and soldier 5 as example) and add Mark for Death Immunity duration after capturing the point.
